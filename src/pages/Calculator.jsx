    ...
    <>
      ...
      <div className="project-container">
        ...
        <div className="project-buttons">
          <a href="https://github.com/Keerthi25098/CalcVerse" target="_blank" rel="noopener noreferrer">GitHub Repository</a>
          <a href="https://calcversee.netlify.app/" target="_blank" rel="noopener noreferrer">Live Demo</a>
        </div>
      </div>
    </>
  );
